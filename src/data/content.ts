...
export const services = {
  ...
  features: [
    ...
    {
      icon: "lock",
      title: "Предотвращение утечек",
      text: "Предотвращаем утечки и несанкционированный доступ к корпоративной информации",
    },
    {
      icon: "fingerprint",
    ...
    },
    {
      ...
      text: "Шифрование, контроль доступа и мониторинг облачных хранилищ в реальном времени",
    },
  ],
} as const;
